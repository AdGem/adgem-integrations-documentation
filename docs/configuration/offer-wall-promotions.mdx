...
<center>
<img alt="Offer Wall Promotion Example" src={require("./img/promo-offerwall-example.png").default} width="400px" />
</center>
...
Follow the steps below to set up an Offer Wall Promotion.
