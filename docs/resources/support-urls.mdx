...
<center>
    <img alt="Support unavailable error page" src="./img/support_not_available_error_page.png" width="350px" />
</center>
...
<center>
    <div style={{display: "inline-block", marginLeft: "10px", marginRight: "10px"}}>
        <img alt="Support portal" src="./img/support_portal.png" width="350px" />
    </div>
    <div style={{display: "inline-block", marginLeft: "10px", marginRight: "10px"}}>
        <img alt="Support portal campaign view" src="./img/support_portal_view.png" width="350px" />
    </div>
</center>
...
<center>
    <img alt="Campaign support URL page" src="./img/support_url.png" width="350px" />
</center>
