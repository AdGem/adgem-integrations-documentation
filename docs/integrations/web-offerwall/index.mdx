...
You can customize the Offerwall appearance including virtual currency name, icon, and multiplier. See the [Customization Guide](/docs/integrations/web-offerwall/customization) for details.
