...
- [Authentication Guide](/targeted-api/authentication) - Complete overview of the authentication flow
- [Offers Query](/targeted-api/operations/queries/offers) - Query targeted offers using your token
