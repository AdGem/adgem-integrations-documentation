...
- **[Prism](/docs/integrate/offer-delivery/partner-built/prism)** (recommended) — AdGem's Offer Personalization API: a GraphQL API that returns personalized, sorted, filtered offers. You keep your UI and gain our personalization. Best for most custom-UI builds.
