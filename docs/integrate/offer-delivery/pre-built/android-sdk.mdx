...
If you have opted for a "Server Postback", on each successful offer completion by a user AdGem will send a GET request to your server. See [Postbacks](/docs/integrate/reward-mechanism/postbacks-v3) to learn more.
