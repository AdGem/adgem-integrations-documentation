  ...
  referenceSidebar: [
    "reference/index",
    {
      ...
      items: [
        ...
        // Generated by `npm run graphql-to-doc` from the live schema; the folders'
        // _category_.yml files drive the Operations/Types layout (standard GraphQL shape).
        { type: "autogenerated", dirName: "reference/prism/operations" },
        { type: "autogenerated", dirName: "reference/prism/types" },
