...
// Generated by `npm run gen-api-docs` (OpenAPI). Source of truth for the Offer API
// operation + schema detail pages; regenerated and committed (WS3, commit-time).
import offerApiSidebar from "./docs/reference/offer-api/sidebar";
  ...
  referenceSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        // Generated OpenAPI detail (Introduction + Offers endpoints & schemas).
        ...offerApiSidebar,
      ],
    },
    {
